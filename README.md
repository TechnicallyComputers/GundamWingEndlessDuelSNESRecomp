...
| `mods/preloaded/packages/` | Shipped mod catalog: widescreen, localization, and the performance log |
...
| `src/diagnostics_mod.c` | Opt-in performance log (`gwed_diagnostics.log` beside the game) for reporting stutters as measurements |
