...
#
# The zip contains the built executable and its runtime assets. It never
...
STAGE="dist/gundamwingendlessduel-$VERSION-$PLATFORM"
...
echo "Packaged: dist/$(basename "$STAGE").zip"
