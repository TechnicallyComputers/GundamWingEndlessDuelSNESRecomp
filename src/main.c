...
{
    const char *rom_path = argc > 1 ? argv[1] : "Shin Kidou Senki Gundam W - Endless Duel (Japan).sfc";
    int rom_size = 0;
    uint8 *rom;
    SDL_Window *window;
